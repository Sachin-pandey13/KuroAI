...
class SemanticPanelSlot(BaseModel):
    ...
    relative_position: RelativePosition = Field(description="Semantic positioning on page layout grid")
...
class MangaPageLayout(BaseModel):
    ...
    slots: List[SemanticPanelSlot] = Field(default_factory=list, description="Ordered semantic panel specifications")
