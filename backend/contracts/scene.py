...
class PanelDescription(BaseModel):
    ...
    camera_angle: str = Field(description="Suggested camera angle (e.g., Close-up, Wide shot, Dutch angle)")
...
class SceneScript(BaseModel):
    ...
    panels: List[PanelDescription] = Field(description="Ordered list of panels making up the scene", default_factory=list)
