...
from backend.capabilities.providers.httpx_providers import LocalLlamaProvider, ComfyUIProvider, Automatic1111Provider
...
def test_comfyui_provider_contract():
    ...
    verify_provider_contract(
        ...
        valid_params={"workflow": {"3": {"inputs": {"text": "hello"}, "class_type": "CLIPTextEncode"}}},
        invalid_params={}
    )
